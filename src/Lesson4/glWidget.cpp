    ...
    xTrans(0),yTrans(0),zTrans(0)
{
    ...
    addMesh("bunny00", "../Lesson3/bunny.obj");
    addMesh("bunny10", "../Lesson3/bunny.obj");

    meshes["bunny10"]->getPosition().setX(2.);


}

void GLWidget::addMesh(const std::string& name, const std::string& file)
{
    Mesh* m = Mesh::createMeshFromObj(file);
    meshes[name] = m;
    this->updateGL();
}
